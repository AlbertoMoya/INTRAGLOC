        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div>
                    ...
                    <h3>PERSONAL DE GRUPO LOGISTICO</h3> 
           ...
           <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="Ubicaciones/">
                           ...
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Cambios de Posición</h6>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="Historico/">
                          <i class="fa fa-user-plus" aria-hidden="true" style="font-size:60px; color:#003463"></i>
                           
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Nuevo Ingreso</h6>
                        </a>
                    </div>
                </div>
            </div>
