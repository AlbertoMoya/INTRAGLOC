...
<head>
   ...
   <body>
    ...
    <div class="logo"><img alt="intercomls" style="width: 140px; height: 80px; text-align: center;" src="../logos/GLOC.png" class="align-right"/>
...
?>
<input type="hidden" name="soporte" value="<?php echo $soporte;?>">
 
<input type="hidden" name="internova" value="<?php echo $internova;?>">
