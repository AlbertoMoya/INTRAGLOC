        ...
        <ul class="links">
          ...
          <?php } ?>
              ...
              <li><a href="GLOC noticias/"  style="color:#003463;font-weight: 700;">Noticias</a></li>
               <li><a href="Tip Ecologico/"  style="color:#003463;font-weight: 700;">Tip Ecológico</a></li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div>
                    ...
                    <h3>Subir y Eliminar Imágenes</h3> 
               ...
               <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="imagenesBotello/eliminar_imagen.php">
                            <i class="fa fa-files-o" aria-hidden="true" style="font-size:60px; color:#003463" ></i>
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Eliminar imagen</h6>
                        </a>
                    </div>
                </div>
            </div>
             ...
             <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="imagenesBotello/deshabilitar_popup.php">
                            <i class="fa fa-files-o" aria-hidden="true" style="font-size:60px; color:#003463" ></i>
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Deshabilitar Popup</h6>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <?php if ($usuario_final=='erick_b') { ?>
               ...
               <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="imagenesBotello/subir_carrusel.php">
                            <i class="fa fa-files-o" aria-hidden="true" style="font-size:60px; color:#003463" ></i>
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Subir Carrusel</h6>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <?php } ?>
              ...
              <?php if ($usuario_final=='erick_b') { ?>
               ...
               <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="imagenesBotello/subir_imagen.php">
                            <i class="fa fa-files-o" aria-hidden="true" style="font-size:60px; color:#003463" ></i>
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >Subir imagen</h6>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <?php } ?>
             ...
             <?php if ($usuario_final=='erick_b') { ?>
               ...
               <div class="col-xs-12 col-sm-4 custom-margin-bottom">
                <div class="members zoom clearfix">
                    <div class="members-text col-xs-12 text-center">
                        <a href="imagenesBotello/subir_popup.php">
                            <i class="fa fa-files-o" aria-hidden="true" style="font-size:60px; color:#003463" ></i>
                           <h6 style="font-size:15px; color:#003463; font-weight: 700;" >POPUP</h6>
                        </a>
                    </div>
                </div>
            </div>
